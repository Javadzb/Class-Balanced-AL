...
class MixNeighborDispersion(Strategy):
	def __init__(self, X, Y, X_te, Y_te,dataset, idxs_lb, net, handler, args, cycle):
		super(MixNeighborDispersion, self).__init__(X, Y, X_te, Y_te, dataset, idxs_lb, net, handler, args, cycle)
