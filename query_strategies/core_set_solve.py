...
r_name = 'mip.pkl'
w_name = 'sols.pkl'
print ('load pickle '+ method_name)

xx, yy, dd, subset, max_dist, budget, n = pickle.load(open(dataset+"_results/"+ method_name+'/'+r_name, 'rb'))
...
while ub-lb > tor:
    ...
    print('##############  stopping criterion is 1e-7 , however it is still = ', ub-lb )
    ...
    if failed:
        ...
        print ("======[Solution Found]======", ub, lb, cur_r)
...
pickle.dump(sols, open(dataset+"_results/"+ method_name+'/' + w_name, 'wb'), 2)
