...
class AdversarialDeepFool(Strategy):
    def __init__(self, X, Y, dataset, idxs_lb, net, handler, args, cycle, max_iter=50):
        super(AdversarialDeepFool, self).__init__(X, Y, dataset, idxs_lb, net, handler, args, cycle)
